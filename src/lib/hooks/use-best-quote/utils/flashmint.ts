...
async function getEnhancedFlashMintQuote(
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            transaction.gas = defaultGasEstimate
            ...
            const outputTokenAmountUsd =
                Number.parseFloat(
                    formatWei(outputAmount, outputToken.decimals)
                ) * outputTokenPrice
            ...
            const outputTokenAmountUsdAfterFees =
                outputTokenAmountUsd - gas.costsUsd
            ...
            const priceImpactPercent =
                (priceImpactUsd / inputTokenAmountUsd) * 100
