...
export async function postApiV2UserAddress({ address }: {
    ...
    const res = await client<PostApiV2UserAddressMutationResponse, PostApiV2UserAddress400 | PostApiV2UserAddress401 | PostApiV2UserAddress403 | PostApiV2UserAddress404 | PostApiV2UserAddress500, PostApiV2UserAddressMutationRequest>({ method: "POST", url: `/api/v2/user/${address}`, baseURL: "https://api-q513.onrender.com", data, ...config });
    return res;
}