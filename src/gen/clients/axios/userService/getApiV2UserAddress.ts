...
export async function getApiV2UserAddress({ address }: {
    ...
    const res = await client<GetApiV2UserAddressQueryResponse, GetApiV2UserAddress400 | GetApiV2UserAddress401 | GetApiV2UserAddress403 | GetApiV2UserAddress404 | GetApiV2UserAddress500, unknown>({ method: "GET", url: `/api/v2/user/${address}`, baseURL: "https://api-q513.onrender.com", ...config });
    return res;
}