...
export async function getApiV2Quote(params: GetApiV2QuoteQueryParams, config: Partial<RequestConfig> = {}) {
    const res = await client<GetApiV2QuoteQueryResponse, GetApiV2Quote400 | GetApiV2Quote401 | GetApiV2Quote404 | GetApiV2Quote500, unknown>({ method: "GET", url: `/api/v2/quote`, baseURL: "https://api.indexcoop/v2", params, ...config });
    return res;
}