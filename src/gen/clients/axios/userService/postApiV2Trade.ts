...
export async function postApiV2Trade(data: PostApiV2TradeMutationRequest, config: Partial<RequestConfig<PostApiV2TradeMutationRequest>> = {}) {
    const res = await client<PostApiV2TradeMutationResponse, PostApiV2Trade400 | PostApiV2Trade401 | PostApiV2Trade403 | PostApiV2Trade500, PostApiV2TradeMutationRequest>({ method: "POST", url: `/api/v2/trade`, baseURL: "https://api-q513.onrender.com", data, ...config });
    return res;
}