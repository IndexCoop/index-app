...
const QuickTrade = (props: {
    ...
    const [buyTokenBalanceFormatted, setBuyTokenBalanceFormatted] =
        useState('0')
    ...
    useEffect(() => {
        ...
        const eiTradeInfoData = getTradeInfoDataFromEI(
            ...
            bestOptionResult.exchangeIssuanceData ?? bestOptionResult.leveragedExchangeIssuanceData,
            sellToken.decimals,
            chainId
        )
    ...
    return (
        ...
        >
            ...
            <Flex direction='column'>
                ...
                {tradeInfoDataEI.length > 0 && (
                    <TradeInfo data={tradeInfoDataEI} />
                )}
                {hasFetchingError && (
