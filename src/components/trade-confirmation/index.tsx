...
export const TradeConfirmation = () => {
  ...
  return (
    <Dialog
      open={Boolean(recentTrade)}
      as='div'
      className='relative z-10 p-0 focus:outline-none'
      onClose={onClose}
    >
      <div className='fixed inset-0 z-10 w-screen overflow-y-auto bg-black/60 backdrop-blur-sm'>
        <div className='flex min-h-full items-center justify-center p-4'>
          <DialogPanel
            transition
            className='data-[closed]:transform-[scale(95%)] bg-ic-gray-950 w-72 max-w-md rounded-lg shadow-lg duration-300 ease-out
