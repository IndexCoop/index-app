...
export function RaffleStatusWrapper({ children }: RaffleStatusWrapperProps) {
  ...
  if (!address) {
    return (
      <div className='flex w-full flex-col gap-4 self-stretch rounded-lg border border-ic-gray-500 bg-ic-black p-6'>
        ...
        <button
          onClick={() => open()}
          className='w-fit rounded-full bg-ic-blue-300 px-6 py-3 text-sm font-semibold text-black transition hover:bg-ic-blue-400'
        >
          Connect wallet
        </button>
      </div>
