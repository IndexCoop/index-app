  ...
  return (
    <Popover className='flex'>
      ...
      <PopoverPanel
        transition
        anchor='bottom'
        className='bg-ic-white dark:bg-ic-blue-950 ring-ic-gray-950/10 dark:ring-ic-gray-50/10 z-10 mt-4 rounded-lg shadow-md ring-1 transition duration-200 ease-in-out data-[closed]:-translate-y-1 data-[closed]:opacity-0'
      >
