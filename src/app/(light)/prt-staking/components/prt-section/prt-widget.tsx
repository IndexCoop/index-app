...
import { ClaimablePanel } from '@/app/(light)/prt-staking/components/prt-section/claimable-panel'
import { SafeSignButton } from '@/app/(light)/prt-staking/components/prt-section/safe-sign-button'
import { StakedPanel } from '@/app/(light)/prt-staking/components/prt-section/staked-panel'
import {
  WidgetHeader,
  WidgetHeaderTokenData,
} from '@/app/(light)/prt-staking/components/prt-section/widget-header'
import { WidgetTabs } from '@/app/(light)/prt-staking/components/prt-section/widget-tabs'
import { usePrtStakingContext } from '@/app/(light)/prt-staking/provider'
import { ProductRevenueToken, WidgetTab } from '@/app/(light)/prt-staking/types'
