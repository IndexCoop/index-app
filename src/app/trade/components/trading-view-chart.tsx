...
import { TradingViewChartContainer } from '@/app/trade/components/trading-view-chart-container'
...
export function TradingViewChart() {
  ...
  return (
    <div className='xs:h-[422px] relative aspect-square w-full lg:aspect-auto'>
      ...
      {!isConnected && (
        <div className='absolute inset-0 z-20 flex items-center justify-center rounded-[4px] bg-zinc-900/85'>
          <Button
