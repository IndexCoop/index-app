...
export function Footer() {
  return (
    <footer className='leading-4 py-12 lg:py-20 mx-auto max-w-7xl px-8 lg:px-12'>
      <div className='mb-8 sm:mb-12 lg:mb-16'>
        <div className='lg:grid lg:grid-cols-4 lg:gap-8'>
          <LogoFull />
          <div className='mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:col-span-3 lg:mt-0'>
            <div>
              <h3 className='text-sm font-semibold leading-6 text-ic-gray-900'>
                Resources
              </h3>
      ...
      <div className='text-xs text-ic-gray-600 font-light space-y-4'>
        <p>
          ...
          contained herein, or any other information that we make available at
          any time, including blog posts, data, articles, links to third-party
          content, discord content, news feeds, tutorials, tweets, and videos.
          Before you make any financial, legal, technical, or other decisions,
          you should seek independent professional advice from a licensed and
          ...
          address all aspects of Index or its products. There is additional
          documentation on Index’s website about the functioning of Index Coop,
          and its ecosystem and community.
        </p>
        <p>
          ...
          which such offer, sale, and/or purchase of any of our token products
          is unlawful, prohibited, or unauthorized (together with U.S. Person, a
          “Restricted Person”). The term “Restricted Person” includes, but is
          not limited to, any natural person residing in, or any firm, company,
          partnership, trust, corporation, entity, government, state or agency
          of a state, or any other incorporated or unincorporated body or
          association, association or partnership (whether or not having
          separate legal personality) that is established and/or lawfully
          existing under the laws of, a jurisdiction in which such offer, sale,
          and/or purchase of any of our token products is unlawful, prohibited,
          or unauthorized). You shall not resell or otherwise transfer our
          restricted tokens to any Restricted Person. The transfer or resale of
          our restricted tokens to any Restricted Person is not permitted. Click{' '}
          <a
            className='underline'
            href='https://indexcoop.com/tokens-restricted-for-restricted-persons'
          >
